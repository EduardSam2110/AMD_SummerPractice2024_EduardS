...
module PISO(clk, reset, pl, IN, OUT);
    ...
    CBBD_2 inst0(clk, reset, temp[0], Q[0] );
...
module tb;
    ...
    initial
    begin
        #0 reset = 1; pl = 0; IN = 8'b0011_1001; IN_serial = 1;
